# Casino Backend AWS Infrastructure
terraform {
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for casino backend"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        },
        {
          ...
          value = var.master_wallet_seed
        },
        {
          name  = "WITHDRAWAL_SECRET"
          value = var.withdrawal_secret
        },
        {
          name  = "LOG_LEVEL"
          value = "info"
