...
exports.TESTNET_FAUCET_AMOUNTS = exports.DEFAULT_HOUSE_EDGE_BPS = exports.LEDGER_TYPES = exports.GAME_CONFIGS = exports.GAMES = exports.CURRENCY_DECIMALS = exports.CURRENCIES = void 0;
exports.CURRENCIES = {
    BTC: 'BTC',
    ETH: 'ETH',
    SOL: 'SOL',
...
exports.LEDGER_TYPES = {
    ...
    FUTURES_IMPACT_FEE: 'FUTURES_IMPACT_FEE',
    FUTURES_BORROW_FEE: 'FUTURES_BORROW_FEE',
    FUTURES_FUNDING: 'FUTURES_FUNDING',
    FUTURES_LIQUIDATION_FEE: 'FUTURES_LIQUIDATION_FEE',
    FUTURES_PNL_WIN: 'FUTURES_PNL_WIN',
    FUTURES_PNL_LOSS: 'FUTURES_PNL_LOSS',
    FUTURES_LIQUIDATION_LOSS: 'FUTURES_LIQUIDATION_LOSS',
};
exports.DEFAULT_HOUSE_EDGE_BPS = 200;
exports.TESTNET_FAUCET_AMOUNTS = {
    [exports.CURRENCIES.BTC]: 0.001,
    [exports.CURRENCIES.ETH]: 0.01,
    [exports.CURRENCIES.SOL]: 0.1,
    [exports.CURRENCIES.USDC]: 10,
    [exports.CURRENCIES.USDT]: 10,
};
