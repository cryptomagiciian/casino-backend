...
export const EnhancedTradingTerminal: React.FC<{ className?: string }> = ({ className = '' }) => {
  // Auth and wallet
  const { user } = useAuth();
  ...
  return (
    <div className={`bg-gray-900 text-white min-h-screen ${className}`}>
      ...
      <div className="flex h-[calc(100vh-200px)]">
        {/* Chart Area - Much Wider */}
        <div className="flex-1 p-6" style={{ minWidth: '70%' }}>
        ...
        {/* Enhanced Order Panel - Narrower */}
        <div className="w-80 p-6 border-l border-gray-700" style={{ minWidth: '30%' }}>
          <div className="h-full bg-gray-800 rounded-lg p-6">
      ...
      {/* Bottom Panel - Positions, History, Top Trades */}
