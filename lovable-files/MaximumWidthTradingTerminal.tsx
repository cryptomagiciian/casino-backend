...
export const MaximumWidthTradingTerminal: React.FC<{ className?: string }> = ({ className = '' }) => {
  // Auth and wallet
  const { user } = useAuth();
  ...
  return (
    <div className={`bg-gray-900 text-white min-h-screen ${className}`}>
      ...
      <div className="flex h-[calc(100vh-180px)]">
        {/* Chart Area - FORCE MAXIMUM WIDTH */}
        <div 
          className="p-2" 
          style={{ 
        ...
        >
          <div className="h-full bg-gray-800 rounded-lg p-2">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-lg font-semibold">{selectedSymbol} • {timeframe} • Real-time</h3>
              <div className="flex items-center space-x-2">
        ...
        {/* Floating Order Panel - MINIMUM WIDTH */}
        {showOrderPanel && (
          <div 
            ...
            <div className="h-full bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-700 rounded-lg p-3">
                  <div className="text-sm text-gray-400 mb-2">Trade Summary</div>
